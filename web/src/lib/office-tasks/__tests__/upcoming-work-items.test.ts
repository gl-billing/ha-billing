...
describe("filterUpcomingWorkItems", () => {
  it("includes open items due after today within the horizon", () => {
    const items = [
      makeItem({ id: "E-1", source: "Event", date: "2026-06-20", assignedTo: "Shiela" }),
      makeItem({ id: "T-1", date: "2026-06-07", assignedTo: "Shiela" }),
      makeItem({ id: "T-2", date: "2026-12-01", assignedTo: "Shiela" })
    ];
