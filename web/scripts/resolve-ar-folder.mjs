/**
 * Resolve AR Drive folder ID via Apps Script (firm Google account).
 * Usage: node scripts/resolve-ar-folder.mjs
 */
...
const res = await fetch(url, {
  ...
  body: JSON.stringify({ token: secret, action: "getArFolderHeadless" }),
  redirect: "follow"
});
...
try {
  ...
  console.error("Non-JSON response from Apps Script. Deploy WebAppApi.gs + WebAppHeadless.gs with getArFolderHeadless first.");
